 ...
 */
// function snacklab_theme_widgets_init()
// {
// 	register_sidebar(
// 		array(
// 			'name'          => esc_html__('Sidebar', 'snacklab-theme'),
// 			'id'            => 'sidebar-1',
// 			'description'   => esc_html__('Add widgets here.', 'snacklab-theme'),
...
// 	);
// }
// add_action('widgets_init', 'snacklab_theme_widgets_init');
